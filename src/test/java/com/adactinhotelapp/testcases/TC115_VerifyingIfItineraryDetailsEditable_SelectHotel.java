...
@Test(groups = {"master"})
public class TC115_VerifyingIfItineraryDetailsEditable_SelectHotel extends BaseClass {
	...
	public void toVerifyingDatesInBookingConfirm() {
		...
		boolean out = bookedItineraryPage.enabledOrNot();
		
		if(out==true) {
			Assert.assertTrue(out, "Is Dissabled");
		}else {
			Assert.assertFalse(out,"Is Unabled");
