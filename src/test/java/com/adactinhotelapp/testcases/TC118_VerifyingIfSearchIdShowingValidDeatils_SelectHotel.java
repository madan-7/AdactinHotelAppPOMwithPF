...
@Test(groups = {"master"})
public class TC118_VerifyingIfSearchIdShowingValidDeatils_SelectHotel extends BaseClass {
	...
	public void toVerifyingFieldsInSelectHotel() {
		...
		Assert.assertEquals(bookedItineraryPage.lastName(), prop.getProperty("lName"));
