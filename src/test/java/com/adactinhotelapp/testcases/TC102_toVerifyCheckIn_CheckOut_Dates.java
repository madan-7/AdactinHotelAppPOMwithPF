...
public class TC102_toVerifyCheckIn_CheckOut_Dates extends BaseClass {
	
	public void verifyingChkInAndChkOutDates() {
		ChainTestListener.log("Test TC102_toVerifyCheckIn_CheckOut_Dates has started");
		Allure.step("Test TC102_toVerifyCheckIn_CheckOut_Dates has started");
	    ...
	    hotelPage.chkInDate(prop.getProperty("chkInDate"));
	    
	    hotelPage.chkOutClear();
	    
	   
	    hotelPage.chkOutDate(prop.getProperty("outDate"));
	    
	    hotelPage.adultsPerRoom(prop.getProperty("adultsPerRoom"));
	    
	    hotelPage.childrenPerRoom(prop.getProperty("childrenPerRoom"));
	    
	    hotelPage.SearchButton();
	    
	    Assert.assertEquals(hotelPage.getErroeMSG(), AppConstants.SEARCH_HOTEL_PAGE_ERROR_MSG_For_chkInChkOutDates);

	    ChainTestListener.log("Test TC102_toVerifyCheckIn_CheckOut_Dates has ended");
		Allure.step("Test TC102_toVerifyCheckIn_CheckOut_Dates has ended");
