...
public class TC114_VerifyingOrderNumber_BookingConfirm extends BaseClass {
	...
	public void toVerifyingDatesInBookingConfirm() {
		...
		if(orderNum!=null) {
		Assert.assertTrue(true,"Order number dispalyed");
			
		}else {
			Assert.assertFalse(false,"Order number not displayed");
		}
