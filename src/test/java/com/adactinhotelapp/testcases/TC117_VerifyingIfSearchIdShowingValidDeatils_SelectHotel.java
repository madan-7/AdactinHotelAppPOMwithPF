...
public class TC117_VerifyingIfSearchIdShowingValidDeatils_SelectHotel extends BaseClass {

	public void toVerifyingFieldsInSelectHotel() {
		
		ChainTestListener.log("TC117_VerifyingIfSearchIdShowingValidDeatils_SelectHotel has started");
		Allure.step("Test TC117_VerifyingIfSearchIdShowingValidDeatils_SelectHotel has started");
